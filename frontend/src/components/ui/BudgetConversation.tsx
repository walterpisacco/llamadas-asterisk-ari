...
export default function BudgetConversation({ raw, t }: BudgetConversationProps) {
    ...
    return (
        ...
        >
            <Typography variant="caption" color="text.secondary" display="block" mb={0.5} fontSize="1rem" fontWeight={600}>
                {t('transcriptions', 'eficiencia_de_conversacion')}
            </Typography>
            <Stack direction="row" spacing={1} alignItems="baseline" flexWrap="wrap" mb={0.5}>
                ...
                <Typography variant="caption" color="text.secondary">
                    {t('transcriptions', cfg.rangeKey)}
                </Typography>
            </Stack>
            <Typography variant="h6" component="p" fontWeight={700} sx={{ color: cfg.border }} mb={1}>
                {formatted}
            </Typography>
